...
│   ├── lifecycle.db        # Unified agent lifecycle metadata (QUEUED/RUNNING/COMPLETED/REJECTED/ACCEPTED)
│   ├── agent-001.db        # Agentlet 1's overlay (disposable execution artifact)
│   └── agent-002.db        # Agentlet 2's overlay (disposable execution artifact)
├── ~/.chimera/
