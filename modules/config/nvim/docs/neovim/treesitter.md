...
get_parser({buf}, {lang}, {opts})                *vim.treesitter.get_parser()*
    ...
    Parameters: ~
      • {buf}   (`integer?`) (default: current buffer) Buffer the parser
                should be tied to
      • {lang}  (`string?`) (default: from 'filetype') Language of this parser
...
select({target}, {count})                            *vim.treesitter.select()*
    ...
    Parameters: ~
      ...
      • {count}   (`integer?`) (default: 1) Expand or adjust the selection
                  this many times.
...
<
    ...
    Parameters: ~
      • {buf}   (`integer?`) (default: current buffer) Buffer to be
                highlighted
      • {lang}  (`string?`) (default: from 'filetype') Language of the parser

stop({buf})                                            *vim.treesitter.stop()*
    Stops treesitter highlighting for a buffer

    Parameters: ~
      • {buf}  (`integer?`) (default: current buffer) Buffer to stop
               highlighting
